...
| `src/reports/finam_v2/` | Finam Report v2: `buildFinamReportV2HtmlPackage.js` для PDF/API при `report_finam=2`, статические страницы-референсы, хвостовые блоки Comon/ДУ/спецпредложения/инфляция/риски/подробный план, goal-страницы включая `page-goal-passive-income-v2.html`, `page-goal-save-grow-v2.html` и `page-goal-other-v2.html`, preview, order, `page-wow-shared.css`, `finamReportV2Contract.js`, экспериментальный `buildFinamReportV2Html.js` |
