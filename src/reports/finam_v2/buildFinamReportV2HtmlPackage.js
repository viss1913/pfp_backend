...
const PAGE_TITLES = Object.freeze({
    ...
    [FINAM_REPORT_V2_PAGE_TYPES.SBER_EQUITIES_SHOWCASE]: 'Акции — витрина Сбер',
    [FINAM_REPORT_V2_PAGE_TYPES.SBER_BONDS_SHOWCASE]: 'Облигации — витрина Сбер',
...
async function buildFinamReportV2PageHtml({
    ...
    const tailPageAliases = {
        ...
        'sber-equities': FINAM_REPORT_V2_PAGE_TYPES.SBER_EQUITIES_SHOWCASE,
        sberequities: FINAM_REPORT_V2_PAGE_TYPES.SBER_EQUITIES_SHOWCASE,
        'sber-equities-showcase': FINAM_REPORT_V2_PAGE_TYPES.SBER_EQUITIES_SHOWCASE,
        'sber-bonds': FINAM_REPORT_V2_PAGE_TYPES.SBER_BONDS_SHOWCASE,
        sberbonds: FINAM_REPORT_V2_PAGE_TYPES.SBER_BONDS_SHOWCASE,
        'sber-bonds-showcase': FINAM_REPORT_V2_PAGE_TYPES.SBER_BONDS_SHOWCASE,
    ...
    const staticRenderers = {
        ...
        [FINAM_REPORT_V2_PAGE_TYPES.SBER_EQUITIES_SHOWCASE]: FINAM_REPORT_V2_PAGE_TYPES.SBER_EQUITIES_SHOWCASE,
        [FINAM_REPORT_V2_PAGE_TYPES.SBER_BONDS_SHOWCASE]: FINAM_REPORT_V2_PAGE_TYPES.SBER_BONDS_SHOWCASE,
