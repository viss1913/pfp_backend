...
| 18 | `page-roadmap-v2.html` | 1 | Дорожная карта 90 дней / 12 месяцев / 3 года |
| 19 | `page-detailed-plan-v2.html` | 2 | Подробный план пополнений: агрегированный календарь по всем не-LIFE целям |
| 20 | `page-risk-declaration-v2.html` | 5 | Декларация о рисках: продукты, компании, матрица `Риск / Доходность`, продуктовые риски и протокол контроля |
